...
export interface InitOutput {
    ...
    readonly __wbg_braid_free: (a: number, b: number) => void;
    ...
    readonly braid_applyFormatPatch: (a: number, b: number) => number;
    readonly braid_applyPatch: (a: number, b: number) => number;
    readonly braid_books: (a: number, b: number) => void;
    readonly braid_booksAwaitingLint: (a: number, b: number) => void;
    readonly braid_chapterLabels: (a: number, b: number, c: number) => number;
    readonly braid_clear: (a: number) => number;
    readonly braid_clearBaseline: (a: number, b: number, c: number) => number;
    readonly braid_diffBaseline: (a: number, b: number) => number;
    readonly braid_expectedSnapshotId: (a: number, b: number) => void;
    readonly braid_isDirty: (a: number, b: number) => number;
    readonly braid_lint: (a: number) => number;
    readonly braid_new: (a: number, b: number) => number;
    readonly braid_patch: (a: number, b: number) => number;
    ...
    readonly braid_publishScope: (a: number, b: number) => number;
    ...
    readonly braid_restoreCorpus: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => number;
    readonly braid_restorePublishedCorpus: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => number;
    readonly braid_revertToBaseline: (a: number, b: number) => number;
    readonly braid_setBaseline: (a: number, b: number) => number;
    readonly braid_setBaselineToCurrent: (a: number, b: number) => number;
    readonly braid_toTokens: (a: number, b: number, c: number) => number;
    readonly braid_toUsfm: (a: number, b: number) => number;
    readonly braid_updateBook: (a: number, b: number) => number;
    readonly braid_updateChapter: (a: number, b: number, c: number) => number;
    readonly braid_updateConfig: (a: number, b: number) => number;
    readonly braid_vrefIndex: (a: number, b: number) => number;
    ...
    readonly verifyPublishedCorpus: (a: number, b: number, c: number, d: number, e: number, f: number) => number;
