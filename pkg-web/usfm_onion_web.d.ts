...
export interface InitOutput {
    ...
    readonly diffTokens: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
    readonly diffUsfm: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
    ...
    readonly parsedusfm_diff: (a: number, b: number, c: number, d: number) => void;
    ...
    readonly parsedusfm_revertDiffBlock: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
    ...
    readonly revertDiffBlock: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => void;
    readonly revertDiffBlocks: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => void;
